 ...
 * date  2019-06
 * 
 * New version for Dandelion project: 
 *  - adds cpnversion factor for EC from raw voltage
 *  - obtains calibration values from configDoc (populated from SD card) rather than EEPROM
 */

#include "Arduino.h"
#include "Dandelion_DFRobot_ESP_EC.h"
#include "EEPROM.h"
...
// Dandelion: added function arguments that represent the calibration factors stored on SD card
void DFRobot_ESP_EC::begin(float slope, float offset)
{
