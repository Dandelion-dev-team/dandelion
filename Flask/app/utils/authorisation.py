...
def auth_check(route, method,id_1, current_user=None):
    ...
    all_routes = [
        ...
        {"route": "/api/experiment_participant/"+id_1, "method": "GET", "auth_level": "public"},
        {"route": "/api/experiment_participant/experiment_id/"+id_1, "method": "POST", "auth_level": "public"},
        ...
        {"route": "/api/project_partner/project_id/school_id", "method": "POST", "auth_level": "superuser"}, #todo this line has 2 id values, needs attention
        ...
        {"route": "/api/user/byschoolandexperiment/school_id/experiment_id", "method": "GET", "auth_level": "superuser"}, #todo this line has 2 id values
