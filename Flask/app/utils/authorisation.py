...
def auth_check(route, method, current_user=None, id_1=None, id_2=None):
    ...
    all_routes = [
        ...
        {"route": "/api/condition/" + id_1 + "/colour", "method": "PUT", "auth_level": "superuser"},
        {"route": "/api/experiment/" + id_1, "method": "GET", "auth_level": "public"},
        {"route": "/api/project/" + id_1 + "/experiment", "method": "GET", "auth_level": "public"},
        {"route": "/api/experiment/" + id_1, "method": "GET", "auth_level": "public"},
        {"route": "/api/experiment/filtered/" + id_1, "method": "GET", "auth_level": "superuser"},
        ...
        {"route": "/api/experiment/" + id_1 + "/treatment", "method": "PUT", "auth_level": "superuser"},
        {"route": "/api/experiment/" + id_1 + "/response", "method": "PUT", "auth_level": "superuser"},
        {"route": "/api/experiment/" + id_1 + "/hypotheses", "method": "PUT", "auth_level": "superuser"},
        {"route": "/api/experiment/" + id_1 + "/conditions", "method": "PUT", "auth_level": "superuser"},
        {"route": "/api/experiment/" + id_1 + "/participants", "method": "PUT", "auth_level": "superuser"},
        {"route": "/api/experiment/" + id_1 + "/status", "method": "PUT", "auth_level": "superuser"},
        {"route": "/api/experiment/" + id_1 + "/uploadImage", "method": "POST", "auth_level": "superuser"},
        {"route": "/api/experiment/" + id_1 + "/clone", "method": "POST", "auth_level": "superuser"},
        {"route": "/api/experiment/" + id_1, "method": "PUT", "auth_level": "superuser"},
        {"route": "/api/experiment_participant", "method": "GET", "auth_level": "experiment_participant"},
        {"route": "/api/experiment_participant/add", "method": "POST", "auth_level": "superuser"},
        {"route": "/api/experiment_participant/" + id_1, "method": "GET", "auth_level": "experiment_participant"},
        ...
        {"route": "/api/project_partner/invitation", "method": "POST", "auth_level": "superuser"},
        ...
        {"route": "/api/unit/" + id_1, "method": "GET", "auth_level": "school_user"},
        {"route": "/api/unit", "method": "POST", "auth_level": "superuser"},
        {"route": "/api/unit/" + id_1, "method": "PUT", "auth_level": "superuser"},
        ...
        {"route": "/api/user/byschoolandexperiment/" + id_1 + "/" + id_2, "method": "GET",
         "auth_level": "superuser"},
        {"route": "/api/user/byproject/" + id_1, "method": "GET", "auth_level": "experiment_participant"},
        ...
        {"route": "/api/variable/treatment", "method": "GET", "auth_level": "superuser"},
        {"route": "/api/variable/response", "method": "GET", "auth_level": "superuser"},
